...
below preserve current production wire shape; broader redesign is narrowed in
DEFERRED.md D-005.
"""
...
# Adding a new event kind requires a docs/contracts update and a paired frontend
# parser change in the same merge.
