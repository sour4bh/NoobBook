...
- Per-connector validation that requires a real product call (not just an SDK ping) — these today live beside their raw-SDK siblings under `services/app_settings/validation/` and move with the connector.
