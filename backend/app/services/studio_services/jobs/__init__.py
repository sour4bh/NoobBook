...
# Ad Jobs: moved to app/studio/marketing/ad/job.py (NBB-505).
# Consumers that previously imported these helpers via this package are
# rewritten to import directly from studio_index_service (which re-exports
# from the new home) or from the new domain-owned module.
