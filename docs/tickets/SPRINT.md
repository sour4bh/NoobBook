...
- No workers in flight. Batch 9 planning pending.
...
| `NBB-209C` | Stores and mechanical moves | Ready | unassigned |  |  |  |  | Deps merged: `NBB-201` at `6aeeffc`. Auth user/password store move. Refactory required. Likely rope-hostile (singleton names match source basename pattern); pre-authorize Cat A/B/C + Blueprint-init in dispatch. Unblocks NBB-705A. |
...
| `NBB-504` | Studio | Ready | unassigned |  |  |  |  | Deps merged: `NBB-503` at `4980de5` (pilot proves 5-file pattern). Migrate document items (blog, business_report, prd, presentation) to `backend/app/studio/documents/<item>/` per LAYER_MAP. Refactory + Cat A/B/C/Blueprint-init pre-auth. |
| `NBB-505` | Studio | Ready | unassigned |  |  |  |  | Deps merged: `NBB-503` at `4980de5`. Migrate marketing items (ad, email, infographic, strategy, social_post) per LAYER_MAP. Refactory + Cat A/B/C/Blueprint-init pre-auth. |
| `NBB-506` | Studio | Ready | unassigned |  |  |  |  | Deps merged: `NBB-503` at `4980de5`. Migrate design items + logo/brand support (component, flow_diagram, logo, website was pilot, wireframe). Refactory + Cat A/B/C/Blueprint-init pre-auth. |
| `NBB-507` | Studio | Ready | unassigned |  |  |  |  | Deps merged: `NBB-503` at `4980de5`. Migrate learning + media items (flash_card, mind_map, quiz, audio, video). Refactory + Cat A/B/C/Blueprint-init pre-auth. |
